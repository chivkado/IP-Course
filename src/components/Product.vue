...
<div class="containe">
  <div class="CardProduct">
    ...
    <div class="CardB">
      ...
      <button type="button" class="butAdd">{{ countSold }}</button>
    </div>
  </div>
</div>
</template>
...
.cardA{
  ...
  position: absolute;
  top: 6%;
  clip-path: polygon(0% 0%, 60% 0%, 80% 50%, 60% 100%, 0%  100%) gray;
}
.CardT {
  width: 100%;
  height: 50%;
...
.butAdd {
  ...
  bottom: 15%;
  right: 7%;
  border: 0.3px solid rgb(26, 0, 128);
  border-radius: 5px;
  font-size: 11px;
  padding: 3px 10px;
